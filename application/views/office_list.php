      ...
      <div class="row">
        <div>
          <h2>Agencies</h2>
			...
			<?php if(!empty($executive_offices)) : ?>
			<div class="panel panel-default">
			<div class="panel-heading">Other Offices Reporting to the White House</div>
			<table class="table table-striped table-hover">
				<tr>
					<th>Agency</th>
					<th>Status</th>
			...
			<?php if(!empty($independent_offices)) : ?>
			<div class="panel panel-default">
			<div class="panel-heading">Other Independent Offices</div>
			<table class="table table-striped table-hover">
				<tr>
					<th>Agency</th>
					<th>Status</th>
